...
Exceptions: Cancellation due to governmental travel restrictions, failure to obtain a visa, or serious illness that prevents travel to the conference will be refunded the full amount paid (Minus up to $50 processing fee) regardless of when the notification is received by the ACL Office but no longer than a week after the conference. The registrant must submit documentation supporting the above cancellation exceptions.     
